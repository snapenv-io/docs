...
It's generated from this documentation site, so it stays in sync with what you're reading here — see [SKILL.md](https://docs.snapenv.io/skill/SKILL.md) and its [reference files on GitHub](https://github.com/snapenv-io/docs/tree/main/public/skill/reference) directly if you want to see exactly what the agent gets.
