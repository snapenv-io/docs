...
It's generated from this documentation site, so it stays in sync with what you're reading here — see [SKILL.md](https://docs.snapenv.io/skill/SKILL.md) and its [reference files](https://docs.snapenv.io/skill/) directly if you want to see exactly what the agent gets.
